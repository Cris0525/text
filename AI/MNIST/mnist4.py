...
def on_mouse(event, x, y, flags, param):
    ...
    if event == cv2.EVENT_LBUTTONDOWN:         #左键点击
        ...
        cv2.rectangle(img2, point1, (x,y), (255,0,0), 1) # 图像，矩形顶点，相对顶点，颜色，粗细
        cv2.imshow('image', img2)
        ...
        cv2.imwrite('/home/cris/Study/AI/MNIST/image/text.png', thresh_img)  # 预处理后图像保存位置

def main():
    global img
    img = cv2.imread('/home/cris/Study/AI/MNIST/image/888.png')  # 手写数字图像所在位置
