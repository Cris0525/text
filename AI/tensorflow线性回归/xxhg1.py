...
def zc_read_csv():
    zc_dataframe = pd.read_csv("/home/cris/人工智能/tensorflow线性回归/HookeLaw.csv", sep=",")
    x = []
    y = []
...
learning_rate = 0.01
Sess = tf.Session()
train_writer = tf.summary.FileWriter("/home/cris/人工智能/tensorflow线性回归/logdir/tensorflows", Sess.graph)
